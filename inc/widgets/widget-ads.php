 ...
 * @since      1.0.0
 */
class Highstake_Ads_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-highstake-ad ad-widget',
			'description' => esc_html__( 'Easily to display any type of ad.', 'highstake' )
		);

		// Create the widget.
		parent::__construct(
			'highstake-ads',                            // $this->id_base
			esc_html__( '&raquo; Advertisement', 'highstake' ), // $this->name
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad_code' ); ?>">
				<?php esc_html_e( 'Ad Code:', 'highstake' ); ?>
			</label>
