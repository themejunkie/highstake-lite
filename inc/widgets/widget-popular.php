 ...
 * @since      1.0.0
 */
class Highstake_Popular_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-highstake-popular posts-thumbnail-widget',
			'description' => esc_html__( 'Display popular posts by comments with thumbnails.', 'highstake' )
		);

		// Create the widget.
		parent::__construct(
			'highstake-popular',                                   // $this->id_base
			esc_html__( '&raquo; Popular Posts Thumbnails', 'highstake' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Popular Posts', 'highstake' ),
			'limit'     => 5,
			'show_date' => false
		);
